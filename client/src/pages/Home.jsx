      ...
      <header className="sticky top-0 z-[100] w-full border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur-xl">
        <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
          ...
          <div className="hidden shrink-0 items-center gap-2 lg:flex">
            <Link
              to="/login"
              className="!bg-transparent rounded-xl px-4 py-2.5 text-[13px] font-bold !text-slate-600 transition-all duration-200 hover:!bg-slate-100 hover:!text-slate-950"
            >
              Log in
            </Link>
