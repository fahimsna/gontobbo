      ...
      <header className="sticky top-0 z-100 w-full border-b border-slate-200 bg-white/95 shadow-sm backdrop-blur-xl">
        <div className="mx-auto flex h-19 max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
          ...
          <div className="hidden shrink-0 items-center gap-2 lg:flex">
            <Link
              to="/login"
              className="rounded-xl bg-transparent! px-4 py-2.5 text-[13px] font-bold text-slate-600! transition-all duration-200 hover:bg-slate-100! hover:text-slate-950!"
            >
              Log in
            </Link>
          ...
          >
            {mobileMenuOpen ? (
              <X size={21} className="text-slate-700!" />
            ) : (
        ...
        <div
          className={`overflow-hidden border-t border-slate-100 bg-white! transition-all duration-300 ease-in-out lg:hidden ${
            mobileMenuOpen ? "max-h-107.5 opacity-100" : "max-h-0 opacity-0"
          }`}
        >
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-slate-950!">
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute -right-40 top-20 h-128 w-lg rounded-full bg-cyan-500/10! blur-3xl" />

            <div className="absolute -bottom-60 left-1/2 h-120 w-120 -translate-x-1/2 rounded-full bg-indigo-500/10! blur-3xl" />
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-5 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
            ...
            <div className="relative mx-auto w-full max-w-xl lg:ml-auto">
              ...
              <div className="relative rounded-4xl border! border-white/10! bg-white/10! p-2 shadow-2xl backdrop-blur-sm">
                <div className="overflow-hidden rounded-3xl bg-white!">
                  ...
                  <div className="relative h-72 overflow-hidden bg-slate-100! sm:h-80">
                    <div className="absolute inset-0 opacity-50">
                      ...
                      <div className="absolute left-[-10%] top-[62%] h-px w-[120%] rotate-[-7deg] bg-slate-300!" />

                      <div className="absolute left-[38%] top-[-20%] h-[140%] w-px rotate-14 bg-slate-300!" />

                      <div className="absolute left-[72%] top-[-10%] h-[130%] w-px rotate-[-40deg] bg-slate-300!" />
                    ...
                    <div className="absolute bottom-[24%] right-[18%] h-16 w-16 rounded-full bg-slate-950/10! blur-xl" />

                    <div className="absolute bottom-[27%] right-[21%] flex h-11 w-11 items-center justify-center rounded-full bg-emerald-500! text-white! shadow-xl">
                      <Car size={19} />
                    </div>
              ...
              {steps.map(({ number, title, text }, index) => (
                ...
                >
                  {index < steps.length - 1 && (
                    <div className="absolute -right-5 top-14 z-10 hidden h-10 w-10 items-center justify-center rounded-full border! border-slate-200! bg-white! text-emerald-500! shadow-sm md:flex">
                      <ArrowRight size={16} />
                    </div>
                  )}
