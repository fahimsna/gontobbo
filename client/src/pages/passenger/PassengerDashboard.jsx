      ...
      <main className="relative z-0 lg:pl-72">
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
          ...
          {!activeRideLoading && activeRide && (
            <section className="relative z-0 mb-8 overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
              <div
          ...
          {!activeRide && (
            ...
            >
              ...
              <div className="relative z-0 min-h-[420px] overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
                <MapView
                  pickup={pickup}
